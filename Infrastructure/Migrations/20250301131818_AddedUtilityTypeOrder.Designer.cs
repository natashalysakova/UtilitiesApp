...
[Migration("20250301131818_AddedUtilityTypeOrder")]
partial class AddedUtilityTypeOrder
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("Infrastructure.Models.Tariff", b =>
            {
                ...
                b.Property<Guid>("UtilityGroupId")
                    .HasColumnType("char(36)");
        ...
        modelBuilder.Entity("Infrastructure.Models.UtilityGroup", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("char(36)");
        ...
        modelBuilder.Entity("Infrastructure.Models.Tariff", b =>
            {
                ...
                b.HasOne("Infrastructure.Models.UtilityGroup", "UtilityGroup")
                    .WithMany()
                    .HasForeignKey("UtilityGroupId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.Navigation("Home");

                b.Navigation("UtilityGroup");
            });
